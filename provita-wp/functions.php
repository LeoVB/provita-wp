...
// Obtener todas las categorías principales de la taxonomía 'producto_categoria'
...
// Obtener las subcategorías de una categoría dada
function get_subcategories($parent_category_id) {
    return get_terms(array(
        'taxonomy' => 'producto_categoria',
        'hide_empty' => false,
...
// Cambia 12 por el número de palabras que desees mostrar.
